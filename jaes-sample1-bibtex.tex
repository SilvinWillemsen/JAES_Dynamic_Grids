...
%Abstract
\abstract{% 
There are many well-established approaches to physical modelling synthesis from musical instrument models. Finite-difference time-domain (FDTD) methods are known for their generality and flexibility in terms of the systems one can model, but are inflexible to smooth parameter variations due to their reliance on a static grid. 
